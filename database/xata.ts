...
const tables = [
  {
    ...
    revLinks: [
      ...
      { column: "nextauth_user", table: "profile" },
      { column: "user", table: "mood" },
    ],
  },
  {
...
export type Mood = InferredTypes["mood"];
export type MoodRecord = Mood & XataRecord;
...
const defaultOptions = {
  databaseURL:
    "https://James-Aspinall-s-workspace-q95ntg.ap-southeast-2.xata.sh/db/georgies",
};
